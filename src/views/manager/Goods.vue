    ...
    <el-dialog title="商品信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        <el-form-item prop="productName" label="商品名称">
          <el-input v-model="data.form.productName" placeholder="请输入商品名称"></el-input>
        </el-form-item>
        <el-form-item prop="stockQuantity" label="库存数量">
          <el-input v-model="data.form.stockQuantity" placeholder="请输入库存数量" type="number"></el-input>
        </el-form-item>
        <el-form-item prop="description" label="描述信息">
          <el-input v-model="data.form.description" placeholder="请输入描述信息"></el-input>
        </el-form-item>
        <el-form-item prop="entryTime" label="入库时间">
          <el-date-picker v-model="data.form.entryTime" type="datetime" placeholder="请选择入库时间"></el-date-picker>
        </el-form-item>
      </el-form>
      <template #footer>
